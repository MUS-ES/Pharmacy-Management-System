   ...
   <section id="sidebar" class="active">
       ...
       <ul class="side-menu">
           ...
           <li>
               ...
               <ul class="side-dropdown">
                   <li><a href="{{ asset('#') }}"><span class="material-icons-outlined">add</span>Add Customer</a>
                   </li>
                   <li><a href="{{ asset('#') }}"><span class="material-icons-outlined">edit</span>Manage
                           Customer</a>
                   </li>
               </ul>
           </li>
           ...
           <li>
               ...
               <ul class="side-dropdown">
                   <li><a href="{{ asset('#') }}"><span class="material-icons-outlined">add</span>Add Medicine</a>
                   </li>
                   <li><a href="{{ asset('#') }}"><span class="material-icons-outlined">edit</span>Manage
                           Medicine</a>
                   </li>
           ...
           <li>
               ...
               <ul class="side-dropdown">
                   <li><a href="{{ asset('#') }}"><span class="material-icons-outlined">add</span>Add Supplier</a>
                   </li>
                   <li><a href="{{ asset('#') }}"><span class="material-icons-outlined">edit</span>Manage
                           Supplier</a>
                   </li>
           ...
           <li>
               ...
               <ul class="side-dropdown">
                   <li><a href="{{ asset('#') }}"><span class="material-icons-outlined">add</span>Add Purchase</a>
                   </li>
                   <li><a href="{{ asset('#') }}"><span class="material-icons-outlined">edit</span>Manage
                           Purchase</a>
                   </li>
           ...
           <li>
               ...
               <ul class="side-dropdown">
                   <li><a href="{{ asset('#') }}"><span
                               class="icon material-icons-outlined">list_alt</span>Invoice</a>
                   </li>
                   <li><a href="{{ asset('#') }}"><span
