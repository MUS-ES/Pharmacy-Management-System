...
@section('title', 'PMS')
@push('head')
    <link rel="stylesheet" href="{{ asset('css/supplier-manage.css') }}">
@endpush

@push('scripts')
    <script src="{{ asset('js/supplier-manage.js') }}"></script>
@endpush
            ...
            <div class= "bill">
                <div class="search-area bill-header">
                   <div class="bill-labelsandinputs">
                       ...
                       <input oninput="search()" id="sea-name" class="input-field" type="text" placeholder="Supplier Name" name="" value="">
                     </div>
